...
<div x-data="{
    ...
    drawer: false,
    outsideClick: false,
    <?php echo e(implode(', ', array_map(function ($item) {
                ...
                <div class="py-4 overflow-y-auto">
                    <ul class="space-y-2 font-medium">
                        <?php $__currentLoopData = $sidebarData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <button type="button" @click="<?php echo e($item['title']); ?> = !<?php echo e($item['title']); ?>; mainMenu = !mainMenu"
                                    ...
                                    <span class="ms-3"><?php echo e($item['title']); ?></span>
                                </button>
