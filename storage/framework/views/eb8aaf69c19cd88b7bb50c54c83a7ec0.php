                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide flex items-center  max-h-[445px] overflow-hidden">
                        ...
                        <div class="w-8/12 relative">
                            <img src="<?php echo e(asset('images/baby-read-book.avif')); ?>" alt=""
                    ...
                    <div class="swiper-slide flex items-center max-h-[445px] overflow-hidden">
                        ...
                        <div class="w-8/12 relative">
                            <img src="<?php echo e(asset('images/mommy-read-book.avif')); ?>" alt=""
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="flex flex-col overflow-hidden">
                        <div class="relative">
                            <img src="<?php echo e(asset('images/baby-read-book.avif')); ?>" alt="" class="h-96 w-full object-cover">
                  ...
                  <div class="swiper-slide">
                    <div class="flex flex-col overflow-hidden">
                        <div class="relative">
                            <img src="<?php echo e(asset('images/mommy-read-book.avif')); ?>" alt="" class="h-96 w-full object-cover">
                ...
                <div class="grid grid-cols-4 gap-4 pt-6 max-sm:grid-cols-2">
                    ...
                    <div class="flex flex-col gap-4 justify-between">
                        <div class="flex flex-col gap-4">
                            <img src="<?php echo e(asset('images/bestseller-pic-1.avif')); ?>" alt="" class="h-72 w-72 object-contain bg-[#FDF8F1]">
                    ...
                    <div class="flex flex-col gap-4 justify-between">
                        <div class="flex flex-col gap-4">
                            <img src="<?php echo e(asset('images/bestseller-pic-2.avif')); ?>" alt="" class="h-72 w-72 object-contain bg-[#FDF8F1]">
                    ...
                    <div class="flex flex-col gap-4 justify-between">
                        <div class="flex flex-col gap-4">
                            <img src="<?php echo e(asset('images/bestseller-pic-3.avif')); ?>" alt="" class="h-72 w-72 object-contain bg-[#FDF8F1]">
                    ...
                    <div class="flex flex-col gap-4 justify-between">
                        <div class="flex flex-col gap-4">
                            <img src="<?php echo e(asset('images/bestseller-pic-4.avif')); ?>" alt="" class="h-72 w-72 object-contain bg-[#FDF8F1]">
...
</div><?php /**PATH /var/www/html/resources/views/livewire/pages/home.blade.php ENDPATH**/ ?>