                ...
                <div class="grid grid-cols-4 gap-4 pt-6">
                    ...
                    <div class="flex flex-col gap-4 justify-between">
                        <div class="flex flex-col gap-4">
                            <img src="<?php echo e(asset('images/bestseller-pic-1.avif')); ?>" alt="" class="h-72 w-72 object-cover bg-[#FDF8F1]">
                    ...
                    <div class="flex flex-col gap-4 justify-between">
                        <img src="<?php echo e(asset('images/bestseller-pic-2.avif')); ?>" alt="" class="h-72 w-72 object-cover bg-[#FDF8F1]">
                    ...
                    <div class="flex flex-col gap-4 justify-between">
                        <div class="flex flex-col gap-4">
                            <img src="<?php echo e(asset('images/bestseller-pic-3.avif')); ?>" alt="" class="h-72 w-72 object-cover bg-[#FDF8F1]">
                    ...
                    <div class="flex flex-col gap-4 justify-between">
                        <div class="flex flex-col gap-4">
                            <img src="<?php echo e(asset('images/bestseller-pic-4.avif')); ?>" alt="" class="h-72 w-72 object-cover bg-[#FDF8F1]">
