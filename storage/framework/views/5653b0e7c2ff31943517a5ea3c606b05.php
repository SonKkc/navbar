        ...
        <div class="max-w-[800px] mx-auto">
            ...
            <ul class="overflow-y-auto h-[450px]">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="hover:bg-gray-200 py-2" wire:click="selectProduct('<?php echo e($product->name); ?>')">
                        <a href="#" class="text-base text-gray-600 hover:text-[#1e5751] hover:bg-gray-200 w-full"><?php echo e($product->name); ?></a>
                    </li>
